# UCC Programación Orientada a Entornos Multimedia - Blender Three.js Mongo Juego 3D
...
| **Compañero zorro** | Sigue al jugador; se teletransporta si queda muy lejos. Animaciones por nombre. |
| **Partículas del portal** | Vórtice multicolor con 250 partículas en modo AdditiveBlending, persistente hasta cambiar de nivel. |
...
| **Ajustes del personaje** | Movimiento WASD, salto (barra espaciadora), correr (Shift). |
...
El frontend se despliega automáticamente al hacer push a la rama principal y es accesible a través de [Juego Desplegado](https://multimedia-threejs-final.vercel.app/)
...
Proyecto Original: Gustavo Willyn Sánchez Rodríguez — guswillsan@gmail.com
Esta versión: Hamilton Santiago Insandara Alvarez y Mario Fernando Santacruz Pantoja
